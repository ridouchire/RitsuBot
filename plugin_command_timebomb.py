...
def event_nick_changed(bot, (presence, room, nick, newnick)):
  #FIXME: bug/feature: reattaching the bomb to different person if original
...
def load(bot):
  bot.add_command('bomb', command_timebomb, LEVEL_GUEST, 'timebomb')
